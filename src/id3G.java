...
public class id3G {
    ...
    public id3G(String trainingSet,String testSet,String modelFile) {
...
/*		//Add randomization
		...
		best=bestList.get(new Random().nextInt(bestList.size())); */
            ...
            if (best.gain > 0) {
               ...
               double thisGINI=1-Math.pow(((double) (thisPN[0]) / (double) (thisPN[0] + thisPN[1])),2)-Math.pow(((double) (thisPN[1]) / (double) (thisPN[0] + thisPN[1])),2);

                if(thisGINI<this.giniLimit){
                    winner=null; //Pruned
                }
            }
        ...
        public void setParent(Node parent) {
            this.parent = parent;
            this.giniLimit =parent.giniLimit;
        }
    }
